...
- The update sequence clears stale SteamCMD bootstrap manifest/cache files on Linux before invoking SteamCMD. This is to avoid SteamCMD parsing an HTML error page as its package manifest.
